...
const SignupPage = () => {
  return (
    <div className="min-h-screen bg-blue-100/50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white rounded-3xl p-8 shadow-2xl">
          ...
          <form className="space-y-5">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="text"
                  placeholder="John"
                  className="h-12 rounded-sm border-gray-200 focus:border-orange-500 focus:ring-orange-500"
                />
              </div>
              <div className="space-y-2">
                <Label
            ...
            <Button className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-sm font-medium text-base">
              Create Account
            </Button>
          </form>
